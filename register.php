...
// Validate Email
        ...
        // Validate Mobile Number (starts with 9 and is 10 digits)
        const mobilePattern = /^[9][0-9]{9}$/;
        if (mobile.value.trim() === '' || !mobilePattern.test(mobile.value)) {
          showError(mobile, 'Please enter a valid 10-digit mobile number starting with 9.');
          isValid = false;
        }
